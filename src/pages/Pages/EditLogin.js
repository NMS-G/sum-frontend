...
const EditLogin = () => {
	...
	const handleSave = () => {
		setSaving(true);
		API.pages.update(data, 7).then(res => {
			setSaving(false);
		...
		<>
			...
			<Box className={classes.section}>
				<Grid container style={{ marginTop: 20 }}>
					<Grid item xs={2}>
						<Typography variant="bodyM">Ekran logowania</Typography>
					</Grid>
					...
					<Grid item xs={2}>
						<Typography variant="bodyM">Przypomnij hasło</Typography>
					</Grid>
					<Grid item xs={10} className={classes.editor}>
						<Editor
							value={data.content1}
					...
					<Grid item xs={2}>
						<Typography variant="bodyM">Zresetuj hasło</Typography>
					</Grid>
					<Grid item xs={10} className={classes.editor}>
						<Editor
							value={data.content2}
